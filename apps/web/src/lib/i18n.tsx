...
const dictionaries: Record<Locale, Dict> = {
  en: {
    ...
    "workspace.movements": "Stock movements",
    "workspace.lowStock": "Low stock",
    "workspace.expiry": "Expiry alerts",
    "workspace.setupImport": "Setup & import",
    ...
    "workspace.productRequests": "Product requests",
    "workspace.importExcel": "Import Excel",
    ...
    "workspace.manufacturers": "Manufacturers",
  ...
  ar: {
    "workspace.dashboard": "لوحة التحكم",
    "workspace.pos": "نقطة البيع",
    "workspace.buy": "الشراء",
    "workspace.marketplace": "السوق",
    "workspace.cart": "السلة",
    "workspace.operations": "العمليات",
    "workspace.orders": "الطلبات",
    "workspace.inventory": "المخزون",
    "workspace.movements": "حركات المخزون",
    "workspace.lowStock": "نقص المخزون",
    "workspace.expiry": "تنبيهات الصلاحية",
    "workspace.setupImport": "الإعداد والاستيراد",
    "workspace.reports": "التقارير",
    "workspace.account": "الحساب",
    "workspace.notifications": "الإشعارات",
    "workspace.settings": "الإعدادات",
    "workspace.catalog": "الكتالوج",
    "workspace.products": "المنتجات",
    "workspace.productRequests": "طلبات إضافة المنتجات",
    "workspace.importExcel": "استيراد Excel",
    "workspace.business": "الأعمال",
    "workspace.network": "الشبكة",
    "workspace.organizations": "المؤسسات",
    "workspace.users": "المستخدمون",
    "workspace.approvals": "الموافقات",
    "workspace.categories": "التصنيفات",
    "workspace.manufacturers": "الشركات المصنّعة",
    "workspace.governance": "الحوكمة",
    "workspace.audit": "سجل التدقيق",
    "nav.home": "الرئيسية",
